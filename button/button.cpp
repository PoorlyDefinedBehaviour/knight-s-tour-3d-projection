...
void Button::draw()
{
  ...
  if (this->type == ButtonType::INCREASE_DARK)
  {
  ...
  if (this->type == ButtonType::DECREASE_DARK)
  {
    SDLController::set_color(0, 0, 0);
    SDLController::render_rectangle(x + 10, y + height / 2.2, width - 20, 5);
    return;
  ...
  if (this->type == ButtonType::INCREASE_LIGHT)
  {
    SDLController::set_color(126, 87, 194);
    SDLController::render_rectangle(x + 10, y + height / 2.2, width - 20, 5);
    SDLController::render_rectangle(x + width / 2.2, y + 10, 5, height - 20);
    return;
  }

  if (this->type == ButtonType::DECREASE_LIGHT)
  {
    SDLController::set_color(126, 87, 194);
    SDLController::render_rectangle(x + 10, y + height / 2.2, width - 20, 5);
    return;
